...
description: Using pageview tracking
---

You can manual `trackPageview` function can be used to track pageviews in server components.
...
```ts
import { trackPageview } from "./simple-analytics";
