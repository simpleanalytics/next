...
<Cards>
  ...
  >
    Tracking events on the client or on the server using Server Actions or Route Handlers.
  </Card>
    <Card
    href="/docs/pageviews"
    title="Tracking pageviews"
  >
    Advanced pageviews tracking using metadata or on the server in Server Components or Middleware.
  </Card>
</Cards>